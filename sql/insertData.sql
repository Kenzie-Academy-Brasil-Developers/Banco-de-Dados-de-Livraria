INSERT INTO
    authors ("name", "bio")
VALUES (
        'Eiichiro Oda', 'Mangaká conhecido pela criação do mangá One Piece.'
    ),
    (
        'J. K. Rowling', 'Escritora, roteirista e produtora cinematográfica britânica, notória pela série de livros Harry Potter.'
    ),
    (
